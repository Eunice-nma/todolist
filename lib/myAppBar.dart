...
*/
 class MyAppBar extends StatefulWidget {
   ...
   MyAppBar({this.headerColor, this.headerText});
   @override
                             ...
                             actions: <Widget>[
                               ...
                               FlatButton(
                                 ...
                                 child: Center(
                                   child: Text(
                                       'Show Completed Task',
                                       style: completedTask? TextStyle(fontSize: 24.0, color: Colors.grey[900], fontWeight: FontWeight.w500):
                                       TextStyle(fontSize: 20.0, color: Colors.grey[600], fontWeight: FontWeight.w500)
                                   ),
                                 ),
                               ),
                               FlatButton(child: Center(
                                 child: Text(
                                     'Show Uncompleted Task',
                                     style: nonCompletedTask? TextStyle(fontSize: 24.0, color: Colors.grey[900], fontWeight: FontWeight.w500):
                                     TextStyle(fontSize: 20.0, color: Colors.grey[600], fontWeight: FontWeight.w500)
                                 ),
                               ),
                                   onPressed: (){
